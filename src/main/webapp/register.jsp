	...
	<body class="style-3">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-push-8">
					...
					<form action="#" class="fh5co-form animate-box" data-animate-effect="fadeInRight">
						...
						<div class="form-group">
							<p>已经注册了吗？ <a href="login.jsp">登录</a></p>
						</div>
						<div class="form-group">
			...
			<div class="row" style="padding-top: 60px; clear: both;">
				<div class="col-md-12 text-center"><p><small>&copy; All Rights Reserved. More Templates <a href="http://www.moobnn.com/" target="_blank" title="拼夕夕众筹">拼夕夕众筹</a>  - Collect from <a href="http://www.moobnn.com/" title="众筹" target="_blank">拼夕夕众筹</a> </small></p></div>
			</div>
		</div>
