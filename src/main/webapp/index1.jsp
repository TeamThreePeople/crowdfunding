...
<head>
	...
	<title>进度条</title>
	<!-- 进度条 -->
	<link rel="stylesheet" type="text/css" href="css/normalize14.css" />
	<link rel="stylesheet" type="text/css" href="css/styles14.css">
</head>
<body>
	...
	<script src='js/stopExecutionOnTimeout14.js?t=1'></script>
