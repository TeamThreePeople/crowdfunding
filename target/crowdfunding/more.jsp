...
<html>
	<head>
		...
		<!-- 小火箭 -->
		<link href="css/huojian.css" rel="stylesheet">
		<!-- 分页按钮 -->
		<link href="css/fenyeanniu.css" rel="stylesheet">
		<!-- 图片缩放 -->
		<link href="css/picturechange.css" rel="stylesheet">
		<!-- 滚动背景 -->
		<link href="css/gundongBackground.css" rel="stylesheet">
		<!-- 先引入jQuery核心js文件 -->
		<script src="js/jquery-3.1.1.js"></script>
		<!-- 引入BootStrap核心js文件 -->
		<script src="js/bootstrap.min.js"></script>
		<!-- 背景滚动 -->
		<script src="js/gundongBackground.js"></script>
