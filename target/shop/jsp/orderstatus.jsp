...
<table class="table table-bordered" style="margin-left: 5px;">
    <tr align="center" >
        <th style="text-align:center; width: 200px;"><span style="color: #000000;">项目信息</span> </th>
        ...
        <th style="text-align:center  ; width: 100px;"><span style="color: #000000;">回报数量</span></th>
    ...
    <tr class="data" align="center">
        <td class="id">
            <img src="${path}/${product.items.pimgs}" width="80px" height="auto"><br>
                ${product.items.name}<br>
                <c:if test="${product.items.completion < 100}">
                    <div class="progress" style="width: 97%;height: 10px;">
                        <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${product.items.completion}%">
                        </div>
                    </div>
                </c:if>
                <c:if test="${product.items.completion >= 100}">
                    <div class="progress" style="width: 97%;height: 10px;">
                        <div class="progress-bar progress-bar-danger " role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${product.items.completion}%">
                        </div>
                    </div>
                </c:if>
        </td>
        ...
        <div class="col-md-12" style="text-align: center">
            <ul class="pagination" style="position: relative;top: 265px;left: 280px;">
                ...
                <c:if test="${vo.pageNow ne 1}">
                    <li ><a class="page-link" onclick="first3('${vo.pageNow-1}','${vo.query1}','${vo.query2}','${vo.query3}','${vo.query4}')" aria-label='Previous' ><span aria-hidden="true">&laquo;</span></a></li>
                </c:if>
                ...
                <c:forEach begin="1" end="${vo.myPages}" var="page">
                    ...
                    <c:if test="${vo.pageNow ne page}">
                        <li ><a class="page-link" onclick="curr3('${page}','${vo.query1}','${vo.query2}','${vo.query3}','${vo.query4}')" >${page}</a></li>
                    </c:if>
                ...
                <c:if test="${vo.pageNow ne vo.myPages}">
                    <li ><a class="page-link" onclick="next3('${vo.pageNow+1}','${vo.query1}','${vo.query2}','${vo.query3}','${vo.query4}')" ><span aria-hidden="true">&raquo;</span></a></li>
                </c:if>
