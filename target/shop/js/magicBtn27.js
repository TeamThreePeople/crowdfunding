...
(function ( $ ) {
    ...
    $.magicBtn = function(selector, options) {
        ...
        $.fn.startLoading = function (options) {
			...
			console.log(settings.loadingText)
        ...
        $.fn.resultLoading = function (options) {
            ...
            if(settings.status == 'success') {
                ...
                if(settings.statusText == '') { settings.statusText = '取消关注';}
                if(settings.statusIcon == '') { settings.statusIcon = '<span>&nbsp;√&nbsp;10</span>';}
                // if(settings.statusIcon == '') { settings.statusIcon = '<i class="fas fa-check" id="member">√&nbsp;10</i>';}
				console.log(settings.statusText)
